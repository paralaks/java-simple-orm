...
public abstract class OrmModel {
  ...
  public final HashMap<String, Object> getOldMap() {
    ...
    return oldMap == null ? null : new HashMap<>(oldMap);
  }
  ...
  public final String tableName() {
    return DbHelper.tableName(getClass());
  }
  ...
  public int count(String where) {
    return db.count(getClass(), where);
  }
  ...
  public <T extends OrmModel> T find(String where) {
    return db.find((Class<T>) getClass(), where, null);
  }
  ...
  public <T extends OrmModel> T find(String where, String orderBy) {
    return db.find((Class<T>) getClass(), where, orderBy);
  }
  ...
  public <T extends OrmModel> List<T> findAll(String where) {
    return (List<T>) db.findAll(getClass(), where, null, null, null);
  }
  ...
  public <T extends OrmModel> List<T> findAll(String where, String orderBy, Integer limitOffset, Integer limitCount) {
    return (List<T>) db.findAll(getClass(), where, orderBy, limitOffset, limitCount);
  }
  ...
  public final boolean save() {
    ...
    if (skipValidation)
      ...
      LOGGER.info("Validation failed for " + getClass().getSimpleName() + " : " + getErrors());
      return false;
    }
  ...
  public boolean importRows(String[] columns, List<Object[]> rows, String[] onDuplicateUpdateColumns) {
    return db.importRows(getClass(), columns, rows, onDuplicateUpdateColumns);
  }
